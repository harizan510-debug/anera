...
const BASICS: BasicItem[] = [
  // Tops
  { category: 'top', subcategory: 'classic tee',        color: 'white',      pattern: 'plain',   fit: 'regular',   tags: ['casual', 'minimal'],       swatchColor: '#F0F0F0', svgShape: 'tee',         imageUrl: '/basics/white-classic-tee.webp' },
  { category: 'top', subcategory: 'sweater',             color: 'white',      pattern: 'plain',   fit: 'regular',   tags: ['casual', 'cosy'],           swatchColor: '#F5F5F0', svgShape: 'tee',         imageUrl: '/basics/white-sweater.webp' },
  { category: 'top', subcategory: 'turtleneck sweater',  color: 'black',      pattern: 'plain',   fit: 'fitted',    tags: ['minimal', 'classic'],       swatchColor: '#2D2D2D', svgShape: 'turtleneck',  imageUrl: '/basics/black-turtleneck.webp' },
  { category: 'top', subcategory: 'crewneck sweater',    color: 'grey',       pattern: 'plain',   fit: 'regular',   tags: ['casual', 'minimal'],        swatchColor: '#ADADAD', svgShape: 'tee',         imageUrl: '/basics/grey-crewneck.webp' },
  { category: 'top', subcategory: 'striped tee',         color: 'navy',       pattern: 'striped', fit: 'regular',   tags: ['casual', 'classic'],        swatchColor: '#1B3060', svgShape: 'striped-tee', imageUrl: '/basics/navy-striped-tee.webp' },
  { category: 'top', subcategory: 'button-down shirt',   color: 'white',      pattern: 'plain',   fit: 'regular',   tags: ['smart', 'versatile'],       swatchColor: '#FAFAFA', svgShape: 'shirt',       imageUrl: '/basics/white-button-down.webp' },
  { category: 'top', subcategory: 'linen shirt',         color: 'beige',      pattern: 'plain',   fit: 'relaxed',   tags: ['casual', 'summer'],         swatchColor: '#D4C5A9', svgShape: 'shirt',       imageUrl: '/basics/beige-linen-shirt.webp' },
  // Bottoms
  { category: 'bottom', subcategory: 'wide-leg jeans',   color: 'light blue', pattern: 'plain',   fit: 'relaxed',   tags: ['casual', 'trendy'],         swatchColor: '#8BB8D8', svgShape: 'jeans',       imageUrl: '/basics/lightblue-wideleg-jeans.webp' },
  { category: 'bottom', subcategory: 'skinny jeans',     color: 'black',      pattern: 'plain',   fit: 'slim',      tags: ['casual', 'versatile'],      swatchColor: '#2A2A2A', svgShape: 'jeans',       imageUrl: '/basics/black-skinny-jeans.webp' },
  ...
  { category: 'footwear', subcategory: 'loafers',        color: 'tan',        pattern: 'plain',   fit: 'regular',   tags: ['smart-casual', 'classic'],  swatchColor: '#C4A882', svgShape: 'loafer',      imageUrl: '/basics/tan-loafers.webp' },
  { category: 'footwear', subcategory: 'heels',          color: 'nude',       pattern: 'plain',   fit: 'regular',   tags: ['elegant', 'versatile'],     swatchColor: '#E8C9A8', svgShape: 'heel',        imageUrl: '/basics/nude-heels.webp' },
  { category: 'footwear', subcategory: 'ballet flats',   color: 'black',      pattern: 'plain',   fit: 'regular',   tags: ['minimal', 'classic'],       swatchColor: '#2A2A2A', svgShape: 'flat',        imageUrl: '/basics/black-ballet-flats.webp' },
  // Outerwear
  { category: 'outerwear', subcategory: 'leather jacket',color: 'black',      pattern: 'plain',   fit: 'regular',   tags: ['edgy', 'cool'],             swatchColor: '#1A1A1A', svgShape: 'jacket',      imageUrl: '/basics/black-leather-jacket.webp' },
  { category: 'outerwear', subcategory: 'trench coat',   color: 'camel',      pattern: 'plain',   fit: 'oversized', tags: ['classic', 'elegant'],       swatchColor: '#C4A86A', svgShape: 'coat',        imageUrl: '/basics/camel-trench-coat.webp' },
  { category: 'outerwear', subcategory: 'blazer',        color: 'navy',       pattern: 'plain',   fit: 'regular',   tags: ['smart', 'work'],            swatchColor: '#1B3060', svgShape: 'blazer',      imageUrl: '/basics/navy-blazer.webp' },
  { category: 'outerwear', subcategory: 'wool coat',     color: 'grey',       pattern: 'plain',   fit: 'oversized', tags: ['classic', 'winter'],        swatchColor: '#8A8A8A', svgShape: 'coat',        imageUrl: '/basics/grey-wool-coat.webp' },
  // Dresses
  { category: 'dress', subcategory: 'midi dress',        color: 'black',      pattern: 'plain',   fit: 'fitted',    tags: ['elegant', 'versatile'],     swatchColor: '#1A1A1A', svgShape: 'midi-dress',  imageUrl: '/basics/black-midi-dress.webp' },
  { category: 'dress', subcategory: 'shirt dress',       color: 'white',      pattern: 'plain',   fit: 'regular',   tags: ['casual', 'effortless'],     swatchColor: '#F5F5F0', svgShape: 'shirt-dress', imageUrl: '/basics/white-shirt-dress.webp' },
  { category: 'dress', subcategory: 'slip dress',        color: 'beige',      pattern: 'plain',   fit: 'regular',   tags: ['minimal', 'elegant'],       swatchColor: '#E0CDB8', svgShape: 'slip-dress',  imageUrl: '/basics/beige-slip-dress.webp' },
  // Bags
  { category: 'bag', subcategory: 'tote bag',            color: 'black',      pattern: 'plain',   fit: 'regular',   tags: ['practical', 'everyday'],    swatchColor: '#1A1A1A', svgShape: 'tote',        imageUrl: '/basics/black-tote-bag.webp' },
  { category: 'bag', subcategory: 'leather tote',        color: 'tan',        pattern: 'plain',   fit: 'regular',   tags: ['classic', 'work'],          swatchColor: '#C4A882', svgShape: 'leather-tote',imageUrl: '/basics/tan-leather-tote.webp' },
  { category: 'bag', subcategory: 'crossbody bag',       color: 'black',      pattern: 'plain',   fit: 'regular',   tags: ['casual', 'practical'],      swatchColor: '#2A2A2A', svgShape: 'crossbody',   imageUrl: '/basics/black-crossbody-bag.webp' },
  // Jewellery
